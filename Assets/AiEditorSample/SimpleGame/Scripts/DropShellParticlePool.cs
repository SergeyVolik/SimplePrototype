...
{
    public abstract class ParticleObjectPool<SingT> : ObjectPoolSingleton<SingT, ParticleSystem>  where SingT : Component
    {
        public void PlayParticleWithPositionAndRotation(Vector3 Postion, Quaternion rotation)
        {
            var blood = Pool.Get();
    ...
    public class DropShellParticlePool : ParticleObjectPool<DropShellParticlePool>
    {
        [SerializeField]
