...
public class AISimulationHuman : MonoBehaviour
{
    [Serializable]
    public struct AgentInData
    {
        ...
        [SerializeField]
        [Range(0, 1)]
        public float GunIsLoaded;
        [SerializeField]
        [Range(0, 1)]
        public float IsInCover;
    }
    ...
    private List<AIAgentHuman> m_SimulationAgents = new List<AIAgentHuman>();
    private List<AIAgentHuman> m_SimulationAgentsToAdd = new List<AIAgentHuman>();
    private List<AIAgentHuman> m_SimulationAgentsToRemove = new List<AIAgentHuman>();

    private bool m_NeedRecreateBuffers;
    private bool m_AgentsSizeUpdated;


    public static AISimulationHuman Instance { get; private set; }
    ...
    private void Awake()
    {
        ...
        {
            Destroy(this);
            Debug.LogWarning("AISimulationHuman is a singleton. A repeaded Component with a AISimulationHuman has been deleted!");
            return;
        }
        ...
        m_SimulationShader = Resources.Load<ComputeShader>("Human");
    ...
    private void AsyncRead(AsyncGPUReadbackRequest req)
    {
        ...
        if (req.hasError)
        {
            Debug.LogError("AISimulationHuman: AsyncRead from gpu has an error");
        }
    }
    ...
    public void AddAgent(AIAgentHuman agent)
    {
    ...
    public void RemoveAgent(AIAgentHuman agent)
    {
...
[CustomEditor(typeof(AISimulationHuman))]
[CanEditMultipleObjects]
public class  InspectorAISimulationHuman : Editor
{
