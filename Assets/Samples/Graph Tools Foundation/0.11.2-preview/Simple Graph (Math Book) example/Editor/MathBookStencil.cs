...
namespace UnityEditor.GraphToolsFoundation.Overdrive.Samples.MathBook
{
    class MathBookStencil : Stencil, ISearcherDatabaseProvider
    {
        ...
        public override void PopulateBlackboardCreateMenu(string sectionName, GenericMenu menu, CommandDispatcher commandDispatcher)
        {
            ...
            menu.AddItem(new GUIContent("Add Int"), false, () =>
            {
                const string newItemName = "variable";
                var finalName = newItemName;
                var i = 0;
                ...
                commandDispatcher.Dispatch(new CreateGraphVariableDeclarationCommand(finalName, true, TypeHandle.Int, typeof(MathBookVariableDeclarationModel)));
            });

            menu.AddItem(new GUIContent("Add float2"), false, () =>
            {
                const string newItemName = "variable";
                var finalName = newItemName;
                var i = 0;
                ...
                commandDispatcher.Dispatch(new CreateGraphVariableDeclarationCommand(finalName, true, TypeHandle.Vector2, typeof(MathBookVariableDeclarationModel)));
            });

            menu.AddItem(new GUIContent("Add float3"), false, () =>
            {
                const string newItemName = "variable";
                var finalName = newItemName;
                var i = 0;
            ...
            menu.AddItem(new GUIContent("Add float4"), false, () =>
            {
                const string newItemName = "variable";
                var finalName = newItemName;
                var i = 0;
                ...
                commandDispatcher.Dispatch(new CreateGraphVariableDeclarationCommand(finalName, true, TypeHandle.Vector4, typeof(MathBookVariableDeclarationModel)));
            });
        }
    }
}
